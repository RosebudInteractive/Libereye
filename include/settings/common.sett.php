<?php
/**
 * Application specific settings for <project>
 * @author <project> Team
 * @package core.config
 */
global $_CONF;
...
//url
$_CONF['url']   =  $_CONF['http'].$_CONF['www'].$_CONF['host'];

//template
$_CONF['template']['dir']   = $_CONF['path'].'design/templates/';
$_CONF['template']['c_dir'] = $_CONF['path'].'design/c_templates/';
$_CONF['template']['image'] = $_CONF['url'].'image/';
$_CONF['template']['url']   = $_CONF['url'];

//mail
$_CONF['mail']['return_path'] = '';
$_CONF['mail']['images_dir']  = $_CONF['path'];
$_CONF['mail']['type'] = 'mail'; // mail - sendmail, smtp - smtp server
$_CONF['mail']['smtp'] = array(
    'host'      => $_CONF['host'],
    'port'      => 25,
    'helo'      => $_CONF['host'],
    'auth'      => false,
...
//file upload
$_CONF['file.max_size'] = 0;
$_CONF['file.path'] = $_CONF['path'].'files/';

//image
$_CONF['image.max_size'] = 0;
$_CONF['image.max_w']    = 2000;
$_CONF['image.max_h']    = 2000;
$_CONF['image.min_w']    = 0;
$_CONF['image.min_h']    = 0;
$_CONF['image.types']    = array('jpg','png','gif');
$_CONF['image.path']     = $_CONF['path'].'images/';

//language and i18n
$_CONF['i18n.default_lang'] = 'en';

//date and time format
$_CONF['format.date%'] = '%m/%d/%Y';
$_CONF['format.date']  = 'm/d/Y h:i A';
$_CONF['format.datetime%'] = '%m/%d/%Y';
$_CONF['format.datetime']   = '%m/%d/%Y %I:%M %p';

// application areas
$_CONF['url.admin'] = $_CONF['url'].'admin/';
$_CONF['url.visitor'] = $_CONF['url'].'visitor/';

//Dynamic Menu settings
$_CONF['menuVars'] = array();
$_CONF['menuVars']["pathToCodeFiles"]   = $_CONF['path'].'include/classes/';

// Настройки динамических страниц
$_CONF['page.extension'] = '.html';	
$_CONF['page.exclude_names'] = array('news');	
