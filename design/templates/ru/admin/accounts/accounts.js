...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            api: {
                read: '/admin/index.php/part_accounts/act_get',
                create: '/admin/index.php/part_accounts/act_create',
                update: '/admin/index.php/part_accounts/act_update',
                destroy: '/admin/index.php/part_accounts/act_destroy'
            },
            reader: {
                type: 'json',
                root: 'data',
    ...
    var gridItems = Ext.create('Ext.grid.Panel', {
	                ...
	                handler: function(){
	                	if (confirm('Точно удалить?')) {
				            ...
				            Ext.each(records, function (record) {
				                ids[ids.length] = record.get('account_id');
				            });
        ...
        listeners : {
		    itemdblclick: function(dv, record, item, index, e) {
		    	document.location = '/admin/index.php/part_accounts/sect_account_edit/id_'+record.raw.account_id;
		    }
		}
    });
});
