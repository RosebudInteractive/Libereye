define(['helpers/record', 'helpers/grid', 'views/forms/slotgen', 'views/forms/seller', 'views/forms/slot'],
    ...
    var form = {
        view:"window", modal:true, id:"shopmanage-win", position:"center",width:1000,
       // head:"Управление магазином",
        head:{
            view:"toolbar", cols:[
                {view:"label", label: "Управление магазином" },
                { view:"button", type: "iconButton", icon: "close", label: "Закрыть", width: 100, align: 'right', click:"$$('shopmanage-win').close();"}
            ]
        }
        ,
        body:{
